...
Future<void> main() async {
  ...
  try {
    if (GetPlatform.isMobile) {
      ...
      print('---Notification_Body---${remoteMessage.data.toString()}/${_body.message}');
      await NotificationHelper.initialize(flutterLocalNotificationsPlugin);
      FirebaseMessaging.onBackgroundMessage(myBackgroundMessageHandler);
    }
  } catch(e) {}

    // PendingDynamicLinkData _initialLink = await FirebaseDynamicLinks.instance.getInitialLink();
...
class MyApp extends StatelessWidget {
  ...
  MyApp({@required this.languages, @required this.orderID, @required this.initialLink});
