...
class _PaginatedListViewState extends State<PaginatedListView> {
  ...
  bool _stopPaginate() {
    ...
    return (_previousList.length == widget.dataList.length);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      Column(children: [
        ...
        (ResponsiveHelper.isDesktop(context) && (_stopPaginate() || _offsetList.contains(_offset+1))) ? SizedBox() : Center(child: Padding(
          padding: ResponsiveHelper.isDesktop(context) ? EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL) : EdgeInsets.zero,
          child: (ResponsiveHelper.isDesktop(context)) ? InkWell(
            onTap: _paginate,
            child: Container(
      ...
      (ResponsiveHelper.isDesktop(context) && (_stopPaginate() || _offsetList.contains(_offset+1))) ? SizedBox() : Container(
