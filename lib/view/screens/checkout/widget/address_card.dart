        ...
        address != null ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          address.firstName != null ? Padding(
            ...
            child: Row(children: [
              ...
              Expanded(child: Text(
                (address.lastName != null) ? (address.firstName + ' ' + address.lastName) : '',
          ...
          Wrap(children: [
            (address.city.isNotEmpty) ? Text('city'.tr+ ': ' + address.city + ', ',
            ...
            (address.state != null ) ? Text('state'.tr +': ' + address.state.name + ', ',
              maxLines: 1, overflow: TextOverflow.ellipsis, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor),
            ) : SizedBox(),

            (address.postcode.isNotEmpty) ? Text('post_code'.tr+': ' + address.postcode,
              maxLines: 1, overflow: TextOverflow.ellipsis, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor),
            ) : SizedBox(),

            (address.country != null) ? Text('country'.tr+': ' + address.country.name,
              maxLines: 1, overflow: TextOverflow.ellipsis, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor),
            ) : SizedBox(),

          ]),
          SizedBox(height: (address.phone.isNotEmpty) ? Dimensions.PADDING_SIZE_SMALL : 0),

          (address.phone.isNotEmpty) ? Text(
            address.phone ?? '', maxLines: 1, overflow: TextOverflow.ellipsis,
            style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
          ) : SizedBox(),

          (address.email.isNotEmpty) ? Text(
