...
class ProductController extends GetxController implements GetxService {
  ...
  void filterOption(int attributeIndex, int optionIndex) {
    ...
    if( attributeIndex+1 == _productAttributes.length){
      ...
      print('LastVariation------------>${_variationAttributes[_variationAttributes.length].toJson()}');
...
/*  void setCartVariationIndex(int index, int i, ProductModel product) {
  ...
  Future<void> getProductDetails(ProductModel product, {bool notify = false, bool formBack = false}) async {
    ...
    if (response.statusCode == 200) {
      ...
      print("_product--+--> ${_product.images[0].src}");
    } else {
  ...
  // String getImageUrl(List<ImageModel> images) =>'https://jeone.jinnbyte-staging.com/wp-content/uploads/2023/06/167113851-84b1da86-5c2a-4cce-9deb-4444848778d4.jpeg';
