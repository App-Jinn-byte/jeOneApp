...
class AppConstants {
  static VendorType vendorType = VendorType.dokan;
  static bool isCountryFixed = false;
  static const String APP_NAME = 'jeOne';
  static const double APP_VERSION = 1.0;
  static const String APP_PACKAGE_NAME = 'com.jeone.jinnbyte';
  static const String PAGINATION_LIMIT = '10';
  static const String DOKAN_ADMIN_STORE_NAME = 'jeOne Mall';


  static const String BASE_URL = 'https://jeone.jinnbyte-staging.com';
  static const String CONSUMER_KEY = 'ck_e10c49bf60e9aa4f0d4c7e8e58e1e3127d268820';
  static const String CUSTOMER_SECRET = 'cs_13437743a9cab9ea8f968893f7bc0cc8cee75528';
  ...
  /// End Url
  static const String PRODUCTS_URI = '/wp-json/woomond/v1/products?type=variable,simple&per_page=$PAGINATION_LIMIT&page=';
  static const String SALE_PRODUCTS_URI = '/wp-json/woomond/v1/products?on_sale&?type=variable,simple&per_page=$PAGINATION_LIMIT&page=';
  static const String POPULAR_PRODUCTS_URI = '/wp-json/woomond/v1/products?order_by=popularity&per_page=$PAGINATION_LIMIT&page=';
  static const String REVIEWED_PRODUCTS_URI = '/products?status=publish&orderby=rating&per_page=$PAGINATION_LIMIT&page=1';
  ...
  static const String CATEGORY_URI = '/products/categories?parent=0&per_page=24&page=';
  static const String SUB_CATEGORY_URI = '/products/categories?parent=';
  static const String CATEGORY_PRODUCT_URI = '/products?status=publish&category=';
  ...
  static const String RUNNING_ORDERS_URI = '/orders?status=pending,processing,on-hold&per_page=10&page=';
  static const String HISTORY_ORDERS_URI = '/orders?status=';
  static const String ALL_ORDERS_URI = '/orders?parent=0&status=pending,processing,on-hold,completed,cancelled,refunded,failed,trash&per_page=10&page=';
  static const String ONGOING_ORDER_URI = '/orders?parent=0&status=pending,processing&per_page=10&page=';
  ...
  static const String NOTIFICATION_URI = '/wp-json/woomond/v1/push_notification_list?per_page=$PAGINATION_LIMIT&page=';
  ...
  static const String FORGET_PASSWORD_URI = '/wp-json/woomond/v1/reset_password?user=';
  ...
  static const String GROUPED_PRODUCT_URI = '/products?type=grouped&per_page=15&page=';
